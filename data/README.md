...
- ajry08five.dta: Income and Democracy Data, [Acemoglu et al. 2008 AER][AJRY08]
  ```stata
  use https://github.com/chan079/panelbook/raw/main/data/ajry08five, clear
  ```

- artificial.dta: Artificial data
  ```stata
  use https://github.com/chan079/panelbook/raw/main/data/artificial, clear
  ```

- basque-clean.dta: [Abadie and Gardeazabal, 2003][AG03], cleaned
  ```stata
  use https://github.com/chan079/panelbook/raw/main/data/basque-clean, clear
  ```

- basque.dta: [Abadie and Gardeazabal 2003][AG03]
  ```stata
  use https://github.com/chan079/panelbook/raw/main/data/basque, clear
  ```

- climate.dta: [Burke, Hsiang, and Miguel, 2015][BHM15]
  ```stata
  use https://github.com/chan079/panelbook/raw/main/data/climate, clear
  ```

- co2pc.dta: CO2 emissions (MT per capita) and GDP per capita (constant 2010 US$); source: [WDI]
  ```stata
  use https://github.com/chan079/panelbook/raw/main/data/co2pc, clear
  ```

- compclust.dta: Simulated data
  ```stata
  use https://github.com/chan079/panelbook/raw/main/data/compclust, clear
  ```

- crime4.dta: [Wooldridge's CRIME4][CRIME4]
  ```stata
  use https://github.com/chan079/panelbook/raw/main/data/crime4, clear
  ```

- did3ex.dta: Simulated data for DID with T=3
  ```stata
  use https://github.com/chan079/panelbook/raw/main/data/did3ex, clear
  ```

- fastfood.dta: [Card and Krueger 1994][CarKru94], fastfood data, cleaned
  ```stata
  use https://github.com/chan079/panelbook/raw/main/data/fastfood, clear
  ```

- growth-ex.dta: Simulated data, growth example
  ```stata
  use https://github.com/chan079/panelbook/raw/main/data/growth-ex, clear
  ```

- grunfeld.dta: Grunfeld, 1958; from [Stata][Stata]
  ```stata
  use https://github.com/chan079/panelbook/raw/main/data/grunfeld, clear
  ```

- hongkong.dta: [Hsiao, Ching and Wan, 2012, J of Appl Econom][HCW12]
  ```stata
  use https://github.com/chan079/panelbook/raw/main/data/hongkong, clear
  ```

- htexample.dta: Hauman and Taylor example
  ```stata
  use https://github.com/chan079/panelbook/raw/main/data/htexample, clear
  ```

- klipsbal.dta (version 13): [KLIPS] for employed, 2005-2015, balanced
  ```stata
  use https://github.com/chan079/panelbook/raw/main/data/klipsbal, clear
  ```

- lfp.dta: Source?
  ```stata
  use https://github.com/chan079/panelbook/raw/main/data/lfp, clear
  ```

- mroz.dta: A [Mroz 1987][Mroz87] data set
  ```stata
  use https://github.com/chan079/panelbook/raw/main/data/mroz, clear
  ```

- mwp.dta: Panel data including wages and family status in [R `feisr` package][feisr]
  ```stata
  use https://github.com/chan079/panelbook/raw/main/data/mwp, clear
  ```

- nastabextr.dta (version 13): A subset of [NASTAB][NASTAB] 1-10
  ```stata
  use https://github.com/chan079/panelbook/raw/main/data/nastabextr, clear
  ```

- oecdca.dta: [WDI][WDI] data 1980-2015
  ```stata
  use https://github.com/chan079/panelbook/raw/main/data/oecdca, clear
  ```

- psidextract.dta: From [Stata][Stata]
  ```stata
  use https://github.com/chan079/panelbook/raw/main/data/psidextract, clear
  ```

- rsqex.dta: Simulated data for R-squareds
  ```stata
  use https://github.com/chan079/panelbook/raw/main/data/rsqex, clear
  ```

- sumhes91.dta: The [Summers and Heston 1991][SumHes91] data set
  ```stata
  use https://github.com/chan079/panelbook/raw/main/data/sumhes91, clear
  ```

- sw2013.dta: [Semykina and Wooldridge, 2013][SemWoo13]
  ```stata
  use https://github.com/chan079/panelbook/raw/main/data/sw2013, clear
  ```

- synth_smoking.dta: [Tobacco Sales in 39 US States][smoking]; [Abadie, Diamond, and Hainmueller 2010][ADH10]
  ```stata
  use https://github.com/chan079/panelbook/raw/main/data/synth_smoking, clear
  ```

- tdum-ex.dta: Simulated data for period dummies
  ```stata
  use https://github.com/chan079/panelbook/raw/main/data/tdum-ex, clear
  ```
...
- twowaycl.dta: Simulated data for two-way cluster se
  ```stata
  use https://github.com/chan079/panelbook/raw/main/data/twowaycl, clear
  ```

- union.dta: NLS Women 14-24 in 1968; from [Stata]
  ```stata
  use https://github.com/chan079/panelbook/raw/main/data/union, clear
  ```

- vv98.dta: [Vella and Verbeek 1998][VelVer98] data
  ```stata
  use https://github.com/chan079/panelbook/raw/main/data/vv98, clear
  ```

- vv98staggered.dta: [Vella and Verbeek, 1998][VelVer98], reduced for 3 period staggered adoption
  ```stata
  use https://github.com/chan079/panelbook/raw/main/data/vv98staggered, clear
  ```

- wdi1bal.dta: [WDI] annual balanced
  ```stata
  use https://github.com/chan079/panelbook/raw/main/data/wdi1bal, clear
  ```

- wdi1data.dta: [WDI] annual unbalanced
  ```stata
  use https://github.com/chan079/panelbook/raw/main/data/wdi1data, clear
  ```

- wdi5bal.dta: [WDI] five year balanced
  ```stata
  use https://github.com/chan079/panelbook/raw/main/data/wdi5bal, clear
  ```

- wdi5data.dta: [WDI] five year unbalanced
  ```stata
  use https://github.com/chan079/panelbook/raw/main/data/wdi5data, clear
  ```

- weakwithin.dta: Simulated data, weak within variability
  ```stata
  use https://github.com/chan079/panelbook/raw/main/data/weakwithin, clear
  ```

- workfile_china.dta: [Autor, Dorn, and Hanson, 2013, The China syndrome](https://www.ddorn.net/data.htm)
  ```stata
  use https://github.com/chan079/panelbook/raw/main/data/workfile_china, clear
  ```

- xttdum.dta: Simulated data
  ```stata
  use https://github.com/chan079/panelbook/raw/main/data/xttdum, clear
  ```

- xtvar.dta: [Data in `xtvar` Stata module][xtvar]
  ```stata
  use https://github.com/chan079/panelbook/raw/main/data/xtvar, clear
  ```
